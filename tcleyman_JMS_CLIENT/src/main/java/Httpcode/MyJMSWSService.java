 ...
 * 
 */
@WebServiceClient(name = "MyJMSWSService", targetNamespace = "http://tcleyman/", wsdlLocation = "http://localhost:7001/MyJMSWS/MyJMSWSService?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        URL url = null;
        try {
            url = new URL(Httpcode.MyJMSWSService.class.getResource("."), "http://localhost:7001/MyJMSWS/MyJMSWSService?WSDL");
